...
struct Monster
{
    ...
    int round_ability;      /**< 特性异常回合参数 */
    float mod_dmg_ability;  /**< 特性威力修正参数 */
    float mod_acc_ability;  /**< 特性命中修正参数 */
    float mod_type_value;   /**< 本系技能提升值 */
    float mod_dodge;        /**< 闪避修正 */
